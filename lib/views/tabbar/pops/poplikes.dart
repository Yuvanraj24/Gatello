            ...
            body: Container(
                ...
                child: Center(
                    child: SingleChildScrollView(
                      child: Column(
                        children: [lottieAnimation(loadingLottie), CircularProgressIndicator()],
                      ),
                    ))),
          );
        }
    ...
    appBar: AppBar(
      leading: GestureDetector(onTap: () {
        Navigator.pop(context);
          ...
          child: Icon(
            Icons.arrow_back, color: Color.fromRGBO(12, 16, 29, 1),)),
      title: InkWell(
        onTap: () {
          print('dhina:${likeListValueNotifier.value.item2.result
              .length}');
        },
        ...
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text('People who likes this pop', style: GoogleFonts
                      .inter(
                      textStyle: TextStyle(
                    ...
                    child: Text('3.6k', style: GoogleFonts.inter(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(width: 1,
                          color: Color.fromRGBO(152, 148, 148, 1),),
                ...
                child: Container(height: 54.h, width: 72.h,
                  decoration: BoxDecoration(borderRadius: BorderRadius
                      ...
                      image: DecorationImage(image: NetworkImage(
                          'https://wallpaper-house.com/data/out/8/wallpaper2you_216880.jpg'),
                          fit: BoxFit.fill)),
                ),
              )
            ],
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                Icons.search_rounded, size: 35, color: Colors.black,
              ),
              filled: true,
              fillColor: Color.fromRGBO(217, 217, 217, 1),
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: Color.fromRGBO(
                    217, 217, 217, 1), width: 1),
          ...
          Expanded(
            child: ListView.builder(
                itemCount: likeListValueNotifier.value.item2.result
                    .length,
                  ...
                  return ListTile(
                    trailing: ElevatedButton(
                        ...
                        child: Text(following ? 'Following' : 'Follow',
                          style: GoogleFonts.inter(
                              textStyle: TextStyle(
                                  color: following ? Color.fromRGBO(
                                      0, 0, 0, 1) : Color.fromRGBO(
                                      0, 163, 255, 1),
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.w700
                              )
                    ...
                    leading: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: NetworkImage(
                              likeListValueNotifier.value.item2
                                  .result[index].profileUrl),
                              fit: BoxFit.fill)
                      ),
                    ),
                    title: Text(
                      likeListValueNotifier.value.item2.result[index]
