                              ...
                              children: [
                                ...
                                RichText(text: TextSpan(style:DefaultTextStyle.of(context).style,
                                    children:[
                                      ...
                                      TextSpan(text:profileDetailsValueNotifier.value.item2.result.profileDetails.company,style: GoogleFonts.inter(textStyle: TextStyle(fontWeight: FontWeight.w400,fontSize:14,color: Color.fromRGBO(0, 0, 0,0.5),decoration:
                                      TextDecoration.none
                                      )))
                                    ])),
                              ],
