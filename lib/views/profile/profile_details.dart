                            ...
                            title: Row(
                              children: [
                                InkWell(
                                  onTap: (){
                                    myFeedsApiCall();
                                   print('myfeedsvalues${ myFeedsValueNotifier.value.item2.result}');
                                  },
                                      ...
                                      (coverImg.isNotEmpty)
                                        ...
                                        errorWidget:
                                            ...
                                            Container(
                                              height: 119.h,
                                              width: double.infinity,
                                            child: Image.network('https://www.wallpaperflare.com/static/135/256/959/butterfly-wings-flutter-shine-wallpaper.jpg'),
                                            ),
                                      )
                                          :  Container(
                                        height: 119.h,
                                                            ...
                                                            builder: (
                                                                ...
                                                                Followers_Page(
                                                                    Id: profileDetailsValueNotifier
                                                                        ...
                                                                        .result
                                                                        .profileDetails
                                                                        .userId.toString(), userName: profileDetailsValueNotifier
                                                                    .value.item2.result.profileDetails
                                                                    .username.toString(), followersCount:  profileDetailsValueNotifier
                                                                    .value
                                                                    .item2
                                                                    .result
                                                                    .profileDetails
