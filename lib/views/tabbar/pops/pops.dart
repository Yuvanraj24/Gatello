    ...
    return SafeArea(
      child: Scaffold(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap:(){
                                            ...
                                            child: SvgPicture.asset('assets/pops_asset/pops_likebutton.svg')),
                                        SizedBox(
                                          width: 7.w,
                                        ),
                                        Text( '3.6k', style: GoogleFonts.inter(
                                          textStyle: TextStyle(
                                            fontWeight: FontWeight.w400,
                                            color:
                                            Color.fromRGBO(51, 51, 51, 1),
       ...
       floatingActionButton:SpeedDial(
         ...
         children: [
           SpeedDialChild(
             child: SvgPicture.asset('assets/pops_asset/floating_comment.svg',color: Color.fromRGBO(0,0,0,1),),
             backgroundColor:  Color.fromRGBO(248, 206, 97, 1),
           ),
           SpeedDialChild(
             child: SvgPicture.asset('assets/pops_asset/interactions.svg',color: Color.fromRGBO(0,0,0,1),),
             backgroundColor:  Color.fromRGBO(248, 206, 97, 1),
           ),
           SpeedDialChild(
             child: SvgPicture.asset('assets/pops_asset/tagpeople.svg',color: Color.fromRGBO(0,0,0,1),),
             backgroundColor:  Color.fromRGBO(248, 206, 97, 1),
           )
         ],
       )
