...
value: 4,
                                      ...
                                      Expanded(child: Container(
                                        ...
                                        child: Row(children: [
                                          ...
                                          SizedBox(width: 14.w),
                                          Text('${globalKey.currentState!. selectedItems!.length} items selected',
                                              style: GoogleFonts.inter(
                                                  textStyle: TextStyle(
                                                    fontSize: 16.sp,
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () {
                                              globalKey.currentState?.deletefun();
                                            ...
                                            child: PopupMenuButton(
                                              onSelected: (value)async{
                                                switch (value){
                                                  ...
                                                  break;
                                                  case 2:{
                                                    globalKey.currentState?.selectAllFun();
                                                  }
                                                }
                                              },
                                                child: Icon(
                                  ...
                                  child: Container(
                                    ...
                                    child: TabBarView(
                                      children: [
                                        ...
                                        PingsChatView(uid:userId.toString(),callBack:callBack,key: globalKey),
                                        // Center(
                                        //   child: Text("Pops...!"),
                                        // ),
                                        Story(
...
selectAllFun(){
            ...
            if (chatRoomdetailsnap.connectionState == ConnectionState.active &&
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    var  pic= docs[index].data()["members"]["${docs[index].data()["members"]["${widget.uid}"]["peeruid"]}"]["pic"];
                    var id= docs[index].data()["members"]["${widget.uid}"]["peeruid"];
                          ...
                          child: ListTile(
                              ...
                              leading: GestureDetector(
                                onTap: (){
                                  ...
                                  heroImg =  docs[index].data()["members"]["${docs[index]
                                ...
                                child: Column(
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        (docs[index].data()["members"]["${docs[index].data()["members"]["${widget.uid}"]["peeruid"]}"]["mute"] == true)?Icon(Icons.volume_off_outlined):SizedBox(),
  ...
  Widget searchBar(){
    return Container(padding:EdgeInsets.symmetric(horizontal:8.w),
      height:40.h,width:320.w,
      child:   TextField(
        autofocus:true,
        cursorColor:Colors.black,cursorHeight:20.h,
        controller:searchChat,
        decoration:InputDecoration(
            filled:true,fillColor:Color.fromRGBO(232, 232, 232, 1),
            hintText:'Search...',contentPadding:EdgeInsets.only(top:10.h),
  ...
  Widget ProfileDP({required var imgHero,}){
    return Container(decoration:BoxDecoration(border:Border.all(width:0)),
        ...
        children: [
          ...
          Hero(tag:"my image",
            child: Container(
              ...
              SvgPicture.asset( "assets/invite_friends/profilepicture.svg", fit: BoxFit.cover,
                width:300.w,
                height:300.h,
              ),
            ),
          )),
          Container(height:40.h,color:Colors.grey,width:300.w,
            child:Row(children: [SizedBox(width:50.w),
              GestureDetector(onTap:() {
                Navigator.push(context, MaterialPageRoute(builder:(context) =>
                    ChatPage(state: 0, uid: widget.uid, puid: docs[index].data()["members"]["${widget.uid}"]["peeruid"])));
              },
                child: Column(
                  mainAxisAlignment:
                  MainAxisAlignment.spaceEvenly,
