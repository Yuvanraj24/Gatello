                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap:(){
                                            print('dhina${profileDetailsValueNotifier.value.item2.result.profileDetails.profileUrl}');
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    image:
                                                  NetworkImage(profileDetailsValueNotifier.value.item2.result.profileDetails.profileUrl),
                                                    fit: BoxFit.fitWidth)
                                            ),
