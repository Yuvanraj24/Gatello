                ...
                child: Column(children: [
                 ...
                 Container(
                   child: TabBar(
                     ...
                     Tab(child:  Row(
                       children: [
                         Text( '86',style:GoogleFonts.inter(textStyle:TextStyle(
                             fontWeight: FontWeight.bold,fontSize:15.sp,
                             color:Color.fromRGBO(0,0,0,1)
                         )),),
                         Text('Followers',style:GoogleFonts.inter(textStyle:TextStyle(
                             fontWeight: FontWeight.bold,fontSize:15.sp,
                             color:Color.fromRGBO(0,0,0,1)
                         )),),
                       ],
                                                 ...
                                                 child: Row(children: [
                                                   Container(
                                                     ...
                                                     decoration: BoxDecoration(
                                                         ...
                                                         image: DecorationImage(image: NetworkImage(
                                                           'https://loveshayariimages.in/wp-content/uploads/2021/10/DP-for-Whatsapp-Profile-Pics-HD.jpg'
                                                          // followListValueNotifier.value.item2.result[index].profilePic,
                                                         ),
                                                             fit: BoxFit.fill)
                                                     ),
                                                   ),
                                                   ...
                                                   Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,
                                                     children: [
                                                       ...
                                                       Text(
                                                           ...
                                                           followListValueNotifier.value.item2.result[index].name,
                                                   ...
                                                   ElevatedButton(style: ElevatedButton.styleFrom(elevation: 0,
                                                     ...
                                                     primary: Color.fromRGBO(255, 255, 255, 1),fixedSize: Size(76.w, 32.h),
                                                       ...
                                                       onPressed: (){
                                                     print('dhina:${followListValueNotifier.value.item2.result[index].profilePic}');
                                             ...
                                             child: Row(children: [
                                               ...
                                               Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,
                                                 children: [
                                                   ...
                                                   Text(    followListValueNotifier.value.item2.result[index].name,style: GoogleFonts.inter(
                                                       textStyle: TextStyle(fontWeight: FontWeight.w400,
                                                           color: Color.fromRGBO(70, 70, 70, 1),fontSize: 14
                                                       )
                                                   ),),
