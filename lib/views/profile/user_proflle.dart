...
class _UserProfileState extends State<UserProfile> {
  ...
  Future profileDetailsApiCall() async {
    ...
    if (widget.uid == 's8b6XInslPffQEgz8sVTINsPhcx2') {
      body = {"user_id":'s8b6XInslPffQEgz8sVTINsPhcx2', "followee_id": ""};
    } else {
      body = {"user_id": widget.uid, "followee_id": 's8b6XInslPffQEgz8sVTINsPhcx2'};
    }
                                  ...
                                  children: [
                                    ...
                                    RichText(text: TextSpan(style:DefaultTextStyle.of(context).style,
                                        children:[
                                          ...
                                          TextSpan(text:profileDetailsValueNotifier.value.item2.result.profileDetails.company,
                                              style: GoogleFonts.inter(textStyle: TextStyle(fontWeight: FontWeight.w400,fontSize:14,
                                                  color: Color.fromRGBO(0, 0, 0,0.5),decoration:TextDecoration.none
                                          )))
                                        ])),
                                  ],
                                ),
                          ...
                          Column(
                            children: [
                              ...
                              Container(padding:EdgeInsets.only(top:10),
                                ...
                                GridView.builder(itemCount:20,shrinkWrap:true,
                                  ...
                                  GridView.builder(itemCount:30,shrinkWrap:true,
                                      itemBuilder: (BuildContext context, int index) {
                                        return Image.network('https://wallpaperaccess.com/full/33115.jpg',fit:BoxFit.fill);},
                                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3,
                                          crossAxisSpacing:3,mainAxisSpacing:3)),
