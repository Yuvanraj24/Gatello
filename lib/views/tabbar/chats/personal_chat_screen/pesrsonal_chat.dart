...
class _PersonalChatState extends State<PersonalChat> with TickerProviderStateMixin {
  int chg = 0;
  String uid = getUID();
  int? state;
                            ...
                            (document["reply"] != null)
                              ...
                              children: [
                                Text(
                                  ...
                                  maxLines: 1,
                                  softWrap: true,
                                  style: GoogleFonts.poppins(textStyle: textStyle(fontSize: 16, color: Color(accent))),
                                ),
                                Container(
                                  padding: EdgeInsets.all(8),
                                  decoration: BoxDecoration(
