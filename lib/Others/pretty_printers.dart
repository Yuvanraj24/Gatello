...
class PrettyPrinter extends StatefulWidget {
  const PrettyPrinter({Key? key}) : super(key: key);

  @override
  State<PrettyPrinter> createState() => _PrettyPrinterState();
}

class _PrettyPrinterState extends State<PrettyPrinter> {
  @override
